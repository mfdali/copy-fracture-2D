...
3. ## Calculate distance between surfaces
   ...
   File: [fracture_aperture_from_core_sample_url](https://github.com/mfdali/copy-fracture-2D/blob/main/fracture_aperture_from_core_sample_url.ipynb)
...
5. ## Numerical Simulation
   ...
   File: [stokes-fracture-tomography_IL](https://github.com/mfdali/copy-fracture-2D/blob/main/stokes-fracture-tomography_IL.py)
